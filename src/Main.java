...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        int size = in.nextInt(); // Ввод размера массива
        int array[] = new int[size]; // Создаём массив

        System.out.println("Введите элементы массива: ");
        for (int i = 0; i < size; i++)
        {
            array[i] = in.nextInt(); // Заполнение массива элементами
        }
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        System.out.print("Количество отрицательных чисел: " + Negative);
//----------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        System.out.print("Введите число A: ");
        int n1A = in.nextInt();
        System.out.print("Введите число B: ");              // не могу разобраться!!!!!!!!
        int n1B = in.nextInt();

//        boolean[] isPrime1 = new boolean[n1A + 1];
//        for (int i = n1B; i <= n1A; i++)
//        {
//            isPrime1[i] = true;
//        }
//        for (int i = n1B; i * i <= n1A; i++)
//        {
//            if (isPrime1[i])
//            {
//                for (int j = i * i; j <= n1A; j += i)
//                {
//                    isPrime1[j] = false;
//                }
//            }
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        System.out.print("Строка в обратном порядке: ");             // не понимаю почему не работает!!!!!!!!!!!!!
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        System.out.println("Условие: Пользователь вводит целое число. Программа должна проверить, является ли это число числом Армстронга (сумма цифр в степени, равной количеству цифр, равна самому числу).");
        System.out.print("Введите число: ");
        int n7 = in.nextInt();
